...
print ("common between c and d {}".format(list(set(c).intersection(d))))

# Extra 2:
# Write this in one line of Python (don’t worry if you can’t figure this 
# out at this point - we’ll get to it soon)

print(list(set([random.randrange(20) for i in range(15)]).intersection([random.randrange(20) for i in range(15)])))